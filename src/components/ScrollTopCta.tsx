    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          className="fixed left-1/2 z-30 flex -translate-x-1/2 cursor-pointer items-center gap-1.5 rounded-full bg-cta px-4 py-2 text-xs font-medium text-white shadow-[var(--shadow-pill)] transition-colors duration-200 hover:bg-cta-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-obsidian/40"
        >
