...
export function AiTrafficDemoCard({
  ...
  return (
    <Card>
      ...
      <div className="mt-5 overflow-hidden rounded-2xl border border-border">
        ...
        <div className="p-4 sm:p-5">
          <p className="flex flex-wrap items-center gap-x-2 gap-y-1 text-sm text-muted">
            ...
            {/* Sur téléphone, la part passe à la ligne : la puce y ouvrirait la
                ligne comme une liste à points. */}
          ...
          {/* Sur téléphone, la courbe perd ce qui ne tient pas dans la largeur :
              l'axe des ordonnées et toutes les dates sauf les deux bouts. */}
          <AreaChart
            data={view.series}
            index="date"
      ...
      <p className="mt-4 text-xs text-ash">{t("noAnalytics")}</p>
