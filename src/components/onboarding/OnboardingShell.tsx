...
/**
 * Le cadre commun aux deux étapes de l'accueil.
 *
 ...
 *
 * Le compteur « ÉTAPE 01 / 02 » est de retour avec la deuxième question. Deux
 * questions annoncées, c'est un engagement qu'on accepte sans réfléchir ; deux
 * questions découvertes une par une, c'est un tunnel dont on ne voit pas le
 * bout, et la deuxième passe pour une de trop.
 */
