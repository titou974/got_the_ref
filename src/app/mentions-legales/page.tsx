  ...
  return (
    <LegalLayout title="Mentions légales" updated="13 juin 2026">
      <p>
        ...
        utilisateurs du site GEOBoost les présentes mentions légales.
      </p>

      <h2>1. Éditeur du site</h2>
      <p>
        Le site GEOBoost est édité par <strong>[Raison sociale]</strong>, [forme juridique : SAS /
      ...
      <p>
        Les analyses fournies par GEOBoost reposent sur des données collectées automatiquement et
