  ...
  return (
    <LegalLayout title="Politique de confidentialité" updated="13 juin 2026">
      <p>
        ...
        « nous ») collecte et traite vos données personnelles dans le cadre du service GEOBoost,
      ...
      <h2>7. Cookies</h2>
      <p>
        GEOBoost utilise uniquement des cookies strictement nécessaires à l'authentification et au
