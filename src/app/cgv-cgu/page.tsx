  ...
  return (
    <LegalLayout title="Conditions Générales de Vente et d'Utilisation" updated="13 juin 2026">
      <p>
        ...
        régissent l'accès et l'utilisation du service got_the_ref (ci-après le « Service »), édité par
      ...
      <h2>1. Objet</h2>
      <p>
        got_the_ref est un outil en ligne (SaaS) permettant d'analyser la visibilité d'un site web dans
