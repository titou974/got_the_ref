      ...
      <div className="mx-auto w-full max-w-5xl flex-1 space-y-6 px-5 py-8">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 flex items-center gap-2 text-xl font-bold">
                ...
                {user.subscription?.status === "active" && (
                  <span className="rounded-full bg-cta/20 px-2 py-0.5 text-xs font-medium text-cta">
                    {t("active")}
                  </span>
                )}
              </p>
            ...
            <div className="flex gap-3">
              {isPaid ? (
                ...
                <Link
                  href={ROUTES.pricing}
                  className="cursor-pointer rounded-xl bg-cta px-5 py-2.5 text-sm font-semibold text-white transition-colors duration-200 hover:bg-cta-hover"
                >
                  {t("upgrade")}
                </Link>
              )}
        ...
        <div>
          <div className="mb-4 flex items-center justify-between">
            ...
            <Link
              href={ROUTES.home}
              className="cursor-pointer rounded-lg bg-white/5 px-4 py-2 text-sm font-medium transition-colors duration-200 hover:bg-white/10"
            >
              {t("newAnalysis")}
            </Link>
          </div>
          ...
          {analyses.length === 0 ? (
            <div className="glass rounded-2xl p-10 text-center">
              ...
              <Link
                href={ROUTES.home}
                className="mt-4 inline-block cursor-pointer rounded-xl bg-cta px-5 py-2.5 text-sm font-semibold text-white transition-colors duration-200 hover:bg-cta-hover"
              >
                {t("analyzeMySite")}
              </Link>
            </div>
              ...
              {analyses.map((a) => (
                <li key={a.id}>
                  <Link
                    ...
                    className="glass flex cursor-pointer items-center gap-4 rounded-xl p-4 transition-colors duration-200 hover:bg-white/[0.07]"
                  >
                    <span
